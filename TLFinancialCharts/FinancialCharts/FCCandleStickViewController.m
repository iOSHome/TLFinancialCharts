...
#import "FCCandleStickViewController.h"
#import "CCSCandleStickChart.h"
#import "CCSCandleStickChartData.h"


@interface FCCandleStickViewController ()

@end

@implementation FCCandleStickViewController
...
- (void)viewDidLoad {
    ...
    CCSCandleStickChart *candleStickChart = [[CCSCandleStickChart alloc] init];
