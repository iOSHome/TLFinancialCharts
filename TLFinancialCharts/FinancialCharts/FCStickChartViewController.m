//
//  FCStickChartViewController.m
//  TLFinancialCharts
//
//  Created by lichuanjun on 2017/10/18.
//  Copyright © 2017年 lichuanjun. All rights reserved.
//

#import "FCStickChartViewController.h"
#import "CCSStickChartData.h"
#import "CCSStickChart.h"

@interface FCStickChartViewController ()

@end

@implementation FCStickChartViewController
...
- (void)viewDidLoad {
    ...
    CCSStickChart *stickchart = [[CCSStickChart alloc] init];
    ...
    stickchart.maxSticksNum = [stickData count]/8;
