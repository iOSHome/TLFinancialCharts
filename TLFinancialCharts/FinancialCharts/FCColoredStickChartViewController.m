//
//  FCColoredStickChartViewController.m
//  TLFinancialCharts
//
...
#import "FCColoredStickChartViewController.h"
#import "CCSColoredStickChartData.h"
#import "CCSColoredStickChart.h"

@interface FCColoredStickChartViewController ()

@end

@implementation FCColoredStickChartViewController
...
- (void)viewDidLoad {
    ...
    CCSColoredStickChart *stickchart = [[CCSColoredStickChart alloc] init];
