...
#import "FCMACDChartViewController.h"
#import "CCSMACDChart.h"
#import "CCSMACDData.h"

@interface FCMACDChartViewController ()

@end

@implementation FCMACDChartViewController
...
- (void)viewDidLoad {
    ...
    CCSMACDChart *stickchart = [[CCSMACDChart alloc] init];
