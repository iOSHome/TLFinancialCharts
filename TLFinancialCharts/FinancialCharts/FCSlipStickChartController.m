...
#import "FCSlipStickChartController.h"
#import "CCSStickChartData.h"
#import "CCSSlipStickChart.h"

@interface FCSlipStickChartController ()

@end

@implementation FCSlipStickChartController
...
- (void)viewDidLoad {
    ...
    CCSSlipStickChart *stickchart = [[CCSSlipStickChart alloc] init];
