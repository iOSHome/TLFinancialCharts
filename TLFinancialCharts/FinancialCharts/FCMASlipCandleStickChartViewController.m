//
//  FCMASlipCandleStickChartViewController.m
//  TLFinancialCharts
//
...
#import "FCMASlipCandleStickChartViewController.h"
#import "CCSMASlipCandleStickChart.h"
#import "CCSCandleStickChartData.h"
#import "CCSLineData.h"
#import "CCSTitledLine.h"

@interface FCMASlipCandleStickChartViewController ()

@end

@implementation FCMASlipCandleStickChartViewController
...
- (void)viewDidLoad {
    ...
    CCSMASlipCandleStickChart *candleStickChart = [[CCSMASlipCandleStickChart alloc] init];
    ...
    @weakify(self);
    [candleStickChart mas_makeConstraints:^(MASConstraintMaker *make) {
        @strongify(self);
