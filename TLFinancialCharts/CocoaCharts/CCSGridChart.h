...
@interface CCSGridChart : CCSBaseChartView {
    NSMutableArray *_latitudeTitles; // 纬度标题数组
    NSMutableArray *_longitudeTitles; // 经度标题数组
    UIColor *_axisXColor; // X轴线的颜色
    UIColor *_axisYColor; // Y轴线的颜色
    UIColor *_longitudeColor; // 经度颜色
    UIColor *_latitudeColor; // 纬度颜色
    UIColor *_borderColor;
    UIColor *_longitudeFontColor;
    UIColor *_latitudeFontColor;
    UIColor *_crossLinesColor; // 交叉线的颜色
    UIColor *_crossLinesFontColor; // 交叉线的字体
    ...
    CCSGridChartXAxisPosition _axisXPosition; // X轴线坐标点
    CCSGridChartYAxisPosition _axisYPosition; // Y轴线坐标点
